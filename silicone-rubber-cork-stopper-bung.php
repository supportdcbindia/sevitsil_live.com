  ...
  <div class="container large">
    <div class="hero-area-service-details-inner section-spacing-top">
      ...
      <div class="product-details-items">
        <div class="product-details-title">
          <h1>Silicone Rubber Cork | Stopper | Bung</h1>
    ...
    <span class="btn-wrap">
        ...
        <div class="product-details-img">
          <img src="assets/imgs/inner-pages/products/silicone-product-range/silicone-laboratory-products/silicone-rubber-cork-stopper-bung/silicone-rubber-cork-stopper-bung.webp" alt="">
        </div>
      </div>
