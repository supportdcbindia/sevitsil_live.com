  ...
  <div class="container large">
    <div class="page-title-area-inner section-spacing-top">
      <div class="page-title-wrapper">
        <h2 class="page-title fade-anim">Process Flow Chart</h2>
      </div>
    </div>
  </div>
</section>
...
<!-- work area start  -->
<section class="work-area-work-page gallery-page-main CustomProcessFlowChart">
  <div class="work-area-work-page-inner">
    <div class="works-wrapper-box">
      <div class="container large">
        <div class="works-wrapper-8 works-wrapper-8-certificate">
          <?php
          $data = glob("assets/imgs/inner-pages/knowledge/process-flow-chart/*.*");
          ?>
          <?php
          foreach ($data as $p) {
          ?>
