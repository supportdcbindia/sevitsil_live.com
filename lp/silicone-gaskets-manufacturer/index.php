        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <div class="bannerContent">
                    ...
                    <h1>Silicone <br> Rubber Gaskets <span>Manufacturer in India</span></h1>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="mobileNone">
                    <div class="bannerImgWrapper cstmbannerImgWrapper">
                        <div class="bannerImgItem">
                            <img src="../assets/images/banner/silicone-gaskets/Image1.jpg" alt="">
                            <!-- <h5>Inflatable Gasket / Tri Clover Gasket</h5> -->
                        </div>
                        <!-- <div class="bannerImgItem">
                            <img src="../assets/images/high-temp-silicone-tubing.webp" alt="">
                            <h5>Tri Clover Gasket</h5>
...
<div class="productSec CustomPeding" id="products">
    <div class="container">
        ...
        <div class="secTitle">
            <h2>Silicone <span>Gaskets</span> Products</h2>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="GlobalContent">
                    <h6>SEVITSIL is a globally trusted silicone gaskets and extrusion manufacturer, supplying high-performance silicone solutions to customers across Europe, Middle East, Africa, Southeast Asia, and the Americas.</h6>
