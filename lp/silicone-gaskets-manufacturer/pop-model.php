...
<!-- <div class="whatsapp-button">
    ...
    <a onclick="gtag('event', 'send', { 'event_category': 'click on whatsapp', 'event_action': 'Mobile', 'event_label': '+<?php #echo $whatappphone; 
        ...
        href="https://api.whatsapp.com/send?phone=<?php #echo $whatappphone; 
                                                    ?>&amp;text=Hello Team <?php #echo $companyname; 
                                                                                                    ?>, I was going through your Website, Please connect me for product discussion."
