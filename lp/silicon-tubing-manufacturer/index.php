        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <div class="bannerContent">
                    ...
                    <h1>Silicone Tubing <span>Manufacturer in India</span></h1>

                    <div class="DesktopNone">
                        <div class="bannerImgWrapper">
                            <div class="bannerImgItem">
                                <img src="../assets/images/food-grade-silicone-tubing.webp" alt="">
                                <h5>Food Grade Silicone Tubing</h5>
                            </div>
                            <div class="bannerImgItem">
                                <img src="../assets/images/high-temp-silicone-tubing.webp" alt="">
                                <h5>High Temp Silicone Tubing</h5>
                            </div>
                            <div class="bannerImgItem">
                                <img src="../assets/images/platinum-cured-silicone-tube.jpg" alt="">
                                <h5>Platinum Cured Silicone Tube</h5>
                            </div>
                            <div class="bannerImgItem">
                                <img src="../assets/images/medical-grade-silicone-tubing.webp" alt="">
                                <h5>Medical Grade Silicone Tubing</h5>
                            </div>
                        </div>
                    </div>
...
<div class="productSec CustomPeding" id="products">
    <div class="container">
        ...
        <div class="secTitle">
            <h2>Silicone <span>Tubing</span> Products</h2>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="GlobalContent">
                    <h6>SEVITSIL is a globally trusted silicone tubing and extrusion manufacturer, supplying high-performance silicone solutions to customers across Europe, Middle East, Africa, Southeast Asia, and the Americas.</h6>
