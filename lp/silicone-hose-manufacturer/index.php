...
<div class="productSec CustomPeding" id="products">
    <div class="container">
        ...
        <div class="secTitle">
            <h2>Silicone <span>Hose</span> Products</h2>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="GlobalContent">
                    <h6>SEVITSIL is a globally trusted silicone hose and extrusion manufacturer, supplying high-performance silicone solutions to customers across Europe, Middle East, Africa, Southeast Asia, and the Americas.</h6>
